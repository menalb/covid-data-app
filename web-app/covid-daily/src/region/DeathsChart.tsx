...
export type DeathsChartData = {
    date: string;
    deaths: number | undefined;
    deathsPrev: number | undefined;
}

const DeathsChart: React.FC<{ chartData: DeathsChartData[] }> = ({ chartData }) => {
    ...
    return (<>
        {last &&
            <p className="flex">
                <LastestValueBox last={{ date: last.date, prev: last.deathsPrev, current: last.deaths }} />
            </p>}
